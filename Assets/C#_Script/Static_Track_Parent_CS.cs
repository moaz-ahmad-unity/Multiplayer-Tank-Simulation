...
namespace ChobiAssets.PTM
{
    ...
    public class Static_Track_Parent_CS : MonoBehaviour//,IPunObservable
    {
        /*
    ...
    //        if (stream.IsReading)
    //        {
    //            Rate_L = (float)stream.ReceiveNext();
    //            Rate_R = (float)stream.ReceiveNext();
    //            Is_Visible = (bool)stream.ReceiveNext();
    //        }
    //        if (stream.IsWriting)
    //        {
    //            stream.SendNext(Rate_L);
    //            stream.SendNext(Rate_R);
    //            stream.SendNext(Is_Visible);
    //        }
    //    }
    //
    }
