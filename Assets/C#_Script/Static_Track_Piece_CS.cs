...
namespace ChobiAssets.PTM
{
    ...
    public class Static_Track_Piece_CS : MonoBehaviour//, IPunObservable
    {
        /*
		...
		*/
        ...
        //    if (stream.IsReading)
        //    {
        //        This_Transform.localPosition = (Vector3)stream.ReceiveNext();
        //        This_Transform.localRotation = (Quaternion)stream.ReceiveNext();
        //    }
        //    if (stream.IsWriting)
        //    {
        //        stream.SendNext(This_Transform.localPosition);
        //        stream.SendNext(This_Transform.localRotation);
        //    }
        //}
    }
